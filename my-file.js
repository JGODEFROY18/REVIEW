...
(0, test_1.test)('a un titre', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, page.goto('http://127.0.0.1:5500/index.html')];
                case 1:
                    _b.sent();
...
(0, test_1.test)('lien pour commencer', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, page.getByRole('button').click()];
                case 2:
                    // Clique sur le lien pour commencer.
                    _b.sent();
